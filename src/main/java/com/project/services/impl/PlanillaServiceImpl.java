...
public class PlanillaServiceImpl implements PlanillaService {
   ...
   //conceptos segun la tabla Concepto
    private static final int CONCEPTO_SUELDO   = 0;
    private static final int CONCEPTO_AFP      = 8;
    private static final int CONCEPTO_TARDANZA = 11;
    private static final int CONCEPTO_FALTA    = 12;
