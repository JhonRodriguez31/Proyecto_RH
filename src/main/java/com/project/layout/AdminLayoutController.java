...
public class AdminLayoutController extends BaseLayoutController {
    ...
    @FXML private Button btnVacation;
    @FXML private Button btnBenefits;
    @FXML private Button btnAudit;

    @Override
    protected void setupMenu() {
        registerMenuButton(btnDashboard,
                "admin-dashboard",
                "/com/project/fxml/pages/admin/dashboard-view.fxml");

        registerMenuButton(btnEmployees,
                "admin-employees",
                "/com/project/fxml/pages/admin/employee-view.fxml");

        registerMenuButton(btnAttendance,
                "admin-attendance",
                "/com/project/fxml/pages/placeholder-view.fxml");
        ...
        registerMenuButton(btnBenefits,
                "admin-benefits",
                "/com/project/fxml/pages/admin/benefit-view.fxml");

        registerMenuButton(btnAudit,
                "admin-audit",
                "/com/project/fxml/pages/placeholder-view.fxml");
    }
