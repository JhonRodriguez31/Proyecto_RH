...
public class UserLayoutController extends BaseLayoutController {
    ...
    protected void setupMenu() {
        registerMenuButton(btnPanel,
                "user-panel",
                "/com/project/fxml/pages/placeholder-view.fxml");

        registerMenuButton(btnDirectory,
                "user-directory",
                "/com/project/fxml/pages/placeholder-view.fxml");
        ...
        registerMenuButton(btnBenefits,
                "user-benefits",
                "/com/project/fxml/pages/user/benefit-view.fxml");
    }
